...
module Kirico
  class DataRecord2202700Spouse < ApplicationRecord
    ...
    validates :qualified_reason_type, inclusion: { in: %i[qualified_reason_type_1 qualified_reason_type_2 qualified_reason_type_3 qualified_reason_type_4 qualified_reason_type_5] }, allow_blank: true
